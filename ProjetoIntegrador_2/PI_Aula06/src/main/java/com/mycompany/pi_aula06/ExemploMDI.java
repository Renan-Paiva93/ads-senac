...
public class ExemploMDI extends javax.swing.JFrame {
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        EditorTextoInterno janelaFilha = new EditorTextoInterno();
        janelaFilha.setVisible(true);
        
        // Denifi o tamanho da tela
        janelaFilha.setPreferredSize(new Dimension(200, 200));
        janelaFilha.pack(); 
        
        // Abrir dentro da janela 
        this.jDesktopPane1.add(janelaFilha);
